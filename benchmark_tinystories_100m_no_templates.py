#!/usr/bin/env python3
"""Benchmark GreedyPhrase tokenizer on tiny_stories_100m without templates."""
import os
import time
from greedyphrase import GreedyPhraseTokenizer

DATA = "data/tiny_stories_100m"
VOCAB = "tokenizer/greedyphrase_ts_no_templates.vocab"
OUTPUT = "data/tiny_stories_100m_no_templates.tokens"
...
# Set template_budget=0 to disable template mining
...
print(f"\n{'='*50}")
print(f"  GreedyPhrase Benchmark (tiny_stories_100m) - No Templates")
print(f"{'='*50}")
